...
// Ejemplo de datos de sesión del usuario
    ...
    <div class="container mt-5">
        ...
        <div id="section-contacto" class="section">
            ...
            <div class="mt-4 text-center">
                ...
                <a href="https://facebook.com" target="_blank" class="icon-link facebook me-3">
                    <i class="bi bi-facebook"></i>
                </a>
                <a href="https://github.com" target="_blank" class="icon-link github">
