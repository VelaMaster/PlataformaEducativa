...
<body>
 ...
 envie el formulario contestado a la basde de datos de la misma maner que este <?php
session_start();
mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT);
...
$sql_respuestas = "SELECT respuestas.id, respuestas.contenido, respuestas.fecha_creacion, alumnos.nombre AS autor 
                   FROM respuestas
                   JOIN alumnos ON respuestas.id_usuario = alumnos.num_control
